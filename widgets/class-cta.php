...
class B2w_Call_To_Action_Widget extends \Elementor\Widget_Base {
    ...
    {
        return ['b2w', 'action', 'call to', 'cta', 'happy'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Bootstrap to Wordpress with Me', 'plugin-b2w'),
            ],
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Learn how to design and build custom, beautiful & responsive WordPress websites and themes for beginners', 'plugin-b2w'),
            ]
        );
